 ...
 * generated in the com.cuongnt.wsclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://ws.cuongnt.com/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://ws.cuongnt.com/", "getHelloWorldAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cuongnt.wsclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cuongnt.com/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cuongnt.com/", name = "getHelloWorldAsString")
