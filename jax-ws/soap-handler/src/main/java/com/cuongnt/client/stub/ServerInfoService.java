 ...
 * 
 */
@WebServiceClient(name = "ServerInfoService", targetNamespace = "http://ws.cuongnt.com/", wsdlLocation = "http://localhost:9999/ws/server?wsdl")
@HandlerChain(file = "soaphandle/client-handle-chain.xml")
    ...
    extends Service
{
    ...
    private final static QName SERVERINFOSERVICE_QNAME = new QName("http://ws.cuongnt.com/", "ServerInfoService");
    ...
    public ServerInfo getServerInfoPort() {
        return super.getPort(new QName("http://ws.cuongnt.com/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.cuongnt.com/", "ServerInfoPort"), ServerInfo.class, features);
    }
