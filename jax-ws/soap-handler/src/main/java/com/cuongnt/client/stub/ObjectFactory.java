 ...
 * generated in the com.cuongnt.client.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ws.cuongnt.com/", "getServerNameResponse");
    private final static QName _GetServerName_QNAME = new QName("http://ws.cuongnt.com/", "getServerName");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cuongnt.client.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cuongnt.com/", name = "getServerNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cuongnt.com/", name = "getServerName")
